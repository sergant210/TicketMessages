...
if ($object->xpdo) {
	...
	switch ($options[xPDOTransport::PACKAGE_ACTION]) {
		...
		case xPDOTransport::ACTION_UPGRADE:
			...
			// Creating MessageUsers user group
			if (!$modx->getCount('modUserGroup', array('name' => 'MessageUsers'))) {
				$data = array('name'=>'MessageUsers');
				$response = $modx->runProcessor('/security/group/create', $data);
				if ($response->isError()) {
