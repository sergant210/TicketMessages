...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
	case xPDOTransport::ACTION_INSTALL:
		$exists =$modx->getObject('transport.modTransportPackage', array('package_name' => 'Tickets'));
		break;
...
if (!$exists) {
	switch ($modx->getOption('manager_language')) {
		case 'ru':
			$output = 'Это расширение требует компонент <b>Tickets</b>.<br/>Он будет автоматически скачан и установлен.';
			break;
		default:
			$output = 'This extension requires the <b>Tickets</b>.<br/><br/>It will be automatically downloaded and installed?';
	}
}
